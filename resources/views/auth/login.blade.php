...
<div class="container" style="margin: 20px;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">ورود کاربر</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- <div class="form-group row">
                            <label for="captcha" class="col-md-4 col-form-label text-md-right">تصویر امنیتی</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="text" class="form-control @error('captcha') is-invalid @enderror" name="captcha" >
