    ...
    <div class="row w-100">
        ...
        <ul style="list-style-type:none;">
            ...
            <li>
                ...
                <input type="checkbox" name="product_name[]" value="<?php echo $value->id ?>"><span><?php echo $value->cat_name ?></span>

                <ul style="list-style-type:none;">
                    @foreach($value->getChild()->get() as $value1)
                    <li>
                        <input type="checkbox" name="product_name[]" value="<?php echo $value1->id ?>"><span><?php echo $value1->cat_name ?></span>
