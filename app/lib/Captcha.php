...
class Captcha
{
    public function create()
    {
        ...
        $font1 = __DIR__ .'..\..\..\public\fonts\/' . rand(1, 5) . '.ttf';
        $font2 = __DIR__ .'..\..\..\public\fonts\/' . rand(1, 5) . '.ttf';
        $font3 = __DIR__ .'..\..\..\public\fonts\/' . rand(1, 5) . '.ttf';
        $font4 = __DIR__ .'..\..\..\public\fonts\/' . rand(1, 5) . '.ttf';
        $font5 =__DIR__ .'..\..\..\public\fonts\/' . rand(1, 5) . '.ttf';
        //dd(realpath($font1));
